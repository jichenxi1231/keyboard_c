...
## 总结:
### 总之由于我第一次写库，并且能力不是很强仅仅实现了一小部分键鼠操作的功能，但是后续我相信我一定能做大做强，若有需要（或许本人也会需要）或许后续会加上注册快捷键的功能与中文输入的功能，并完善快捷键任意点击，键盘任意点击等功能，最后本库会有一个示例cmake链接，可用根据实际情况进行更改，最后感谢大佬们的支持(如果可以，能打赏一丢丢)
